  ...
  return (
    <div className={`cd-flex cd-flex-row cd-justify-start ${className}`}>
      ...
      <input
        ...
        className="cd-mt-1 cd-block cd-mx-3 cd-w-4 cd-h-4 cd-border cd-border-gray-300 cd-rounded-md cd-shadow-sm focus:cd-outline-none focus:cd-ring-indigo-500 focus:cd-border-indigo-500 sm:cd-text-sm"
      />
